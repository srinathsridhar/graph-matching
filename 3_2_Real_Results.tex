...
product in the catalog of a merchant and the edges connect similar products.
The edges of the supergraph were determined with the help of a several heuristic
algorithms that extracted relevant keywords and values from the descriptions 
of the products. These keywords may relate to such properties
of the product as color, year of manufacture, country of origin, materials, 
or other properties. The union of the recommendations for each product from each
heuristic were then reduced to at most 50 edges. In practice, it our recommendation
to be more permissive with including edges in the supergraph, than it is to be
exclusive.
