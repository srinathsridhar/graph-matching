...
of $G$ can be assumed to be pre-sorted by the endpoint of each edge in $L$. 
...
solution to be 95\% optimal for different values of $a$, both in the fixed degree model. 
...
function of $ck$ for the $(c,1)$-recommendation subgraph problem in the fixed degree model. 
...
solution to be 95\% optimal for different values of $a$, again in the fixed degree model. 
