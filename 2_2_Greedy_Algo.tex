...
%generated the recommendation subgraph.  
...
When the underlying random graph is sufficiently dense, Theorem~\ref{simple-thm} shows that the above guarantee is asymptotically optimal.  
%
%\begin{proof}
