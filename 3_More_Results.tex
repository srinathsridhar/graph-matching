...
\begin{figure}[h]
  ...
  \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c| }
    ...
    \hline
  \end{tabular}
  \caption{Percent edges by LCA of endpoints in reality (Hier) and in simulated uniform distribution.}\label{fig:hier}
\end{figure}
...
\begin{thm}
With $S$, $G$ and $H$ defined as above, we have \vspace{-0.1in}
