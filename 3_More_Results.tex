...
The analyses for these different model are carried out are similar to the
analyses we carried out for the fixed-degree model. While only present
results for the approximation $(c,1)$-recommendation subgraphs in expectation for brevity, 
